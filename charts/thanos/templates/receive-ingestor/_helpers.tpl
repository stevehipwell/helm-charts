...
{{ printf "- %s" ((printf "%s-%s.%s-headless.%s.svc.%s:%s" (include "thanos.receive.ingestor.fullname" $) (toString .) (include "thanos.receive.ingestor.fullname" $) $.Release.Namespace $.Values.clusterDomain $.Values.grpcPort) | quote) }}
{{- end }}
{{- end -}}
