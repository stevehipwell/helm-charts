...
- Update the _PlantUML_ OCI image to [v1.2026.6](https://github.com/plantuml/plantuml-server/releases/tag/v1.2026.6). ([#1382](https://github.com/stevehipwell/helm-charts/pull/1382)) @stevehipwell

## [v3.47.0] - 2026-06-12

### Changed

- Update the _PlantUML_ OCI image to [v1.2026.5](https://github.com/plantuml/plantuml-server/releases/tag/v1.2026.5). ([#1381](https://github.com/stevehipwell/helm-charts/pull/1381)) @stevehipwell
...
- Update the _PlantUML_ OCI image to [v1.2025.10](https://github.com/plantuml/plantuml-server/releases/tag/v1.2025.10). ([#1289](https://github.com/stevehipwell/helm-charts/pull/1289)) _@stevehipwell_
...
- Update the _PlantUML_ OCI image to [v1.2025.7](https://github.com/plantuml/plantuml-server/releases/tag/v1.2025.7). ([#1252](https://github.com/stevehipwell/helm-charts/pull/1252)) _@stevehipwell_

## [v3.39.0] - 2025-07-15

### Changed

- Update the _PlantUML_ OCI image to [v1.2025.4](https://github.com/plantuml/plantuml-server/releases/tag/v1.2025.4). ([#1213](https://github.com/stevehipwell/helm-charts/pull/1213)) _@stevehipwell_
...
[v3.24.1]: https://github.com/stevehipwell/helm-charts/releases/tag/plantuml-3.24.1
[v3.24.0]: https://github.com/stevehipwell/helm-charts/releases/tag/plantuml-3.24.0
[v3.23.0]: https://github.com/stevehipwell/helm-charts/releases/tag/plantuml-3.23.0
