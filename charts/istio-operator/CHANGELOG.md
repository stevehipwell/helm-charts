...
- Updated the _Istio Operator_ OCI image version to [v1.23.5](https://github.com/istio/istio/releases/tag/1.23.5). ([#1164](https://github.com/stevehipwell/helm-charts/pull/1164)) _@stevehipwell_
...
- Updated the _Istio Operator_ OCI image version to [v1.23.4](https://github.com/istio/istio/releases/tag/1.23.4). ([#1099](https://github.com/stevehipwell/helm-charts/pull/1099)) _@stevehipwell_
...
- Updated the _Istio Operator_ OCI image version to [v1.23.2](https://github.com/istio/istio/releases/tag/1.23.2).
...
- Updated the _Istio Operator_ OCI image version to [v1.23.1](https://github.com/istio/istio/releases/tag/1.23.1).
...
- Updated the _Istio Operator_ OCI image version to [v1.23.0](https://github.com/istio/istio/releases/tag/1.23.0).

## [v2.15.3] - 2024-07-19

### Changed

- Updated the _Istio Operator_ OCI image version to [v1.22.3](https://github.com/istio/istio/releases/tag/1.22.3).
...
[v2.16.7]: https://github.com/stevehipwell/helm-charts/releases/tag/istio-operator-2.16.7
...
[v2.15.3]: https://github.com/stevehipwell/helm-charts/releases/tag/istio-operator-2.15.3
