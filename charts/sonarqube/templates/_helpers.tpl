...
{{- define "sonarqube.kubeVersion" -}}
  {{- default .Capabilities.KubeVersion.Version (regexFind "v[0-9]+\\.[0-9]+\\.[0-9]+" .Capabilities.KubeVersion.Version) -}}
{{- end -}}

{{/* Get Ingress API Version */}}
{{- define "sonarqube.ingress.apiVersion" -}}
  {{- if and (.Capabilities.APIVersions.Has "networking.k8s.io/v1") (semverCompare ">= 1.19.x" (include "sonarqube.kubeVersion" .)) -}}
...
{{- define "sonarqube.ingress.supportsPathType" -}}
  {{- or (eq (include "sonarqube.ingress.isStable" .) "true") (and (eq (include "sonarqube.ingress.apiVersion" .) "networking.k8s.io/v1beta1") (semverCompare ">= 1.18.x" (include "sonarqube.kubeVersion" .))) -}}
{{- end -}}
