...
![Version: 2.13.3](https://img.shields.io/badge/Version-2.13.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.40.7](https://img.shields.io/badge/AppVersion-1.40.7-informational?style=flat-square)
...
```shell
helm upgrade --install tigera-operator oci://ghcr.io/stevehipwell/helm-charts/tigera-operator --version 2.13.3
```
...
helm upgrade --install tigera-operator stevehipwell/tigera-operator --version 2.13.3
```
