...
| `config.rootPassword.enabled`             | Whether to automatically set a new root password                                        | `false`             |
| `config.rootPassword.secret`              | Set the name of an existing Kubernetes secret to use for setting the admin password     | `nexus-secrets`     |
| `config.rootPassword.key`                 | Set the key of the key-value pair defining the admin password within the secret         | `rootPassword`      |
| `config.anonymous.enabled`                | Whether to allow unauthenticated read access to Nexus3                                  | `false`             |
| `config.realms`                           | Set additional Realm identifier you want to enable (see values.yaml for examples)       | `[]`                |
| `config.ldap.enabled`                     | Enable LDAP configuration                                                               | `false`             |
| `config.ldap.name`                        | Name of the LDAP configuration                                                          | `example-ldap`      |
| `config.ldap.host`                        | Set the LDAP host                                                                       | `example.com`       |
| `config.ldap.protocol`                    | Set the LDAP protocol                                                                   | `ldap`              |
| `config.ldap.port`                        | Set the LDAP server port                                                                | `389`               |
| `config.ldap.auth`                        | Set the LDAP authentication mechanism                                                   | `simple`            |
| `config.ldap.username`                    | Set the LDAP username                                                                   | `service-account`   |
| `config.ldap.password.secret`             | Set the name of an existing Kubernetes secret to use for setting the LDAP password      | `nexus-secrets`     |
| `config.ldap.password.key`                | Set the key of the key-value pair defining the LDAP password within the secret          | `ldapPassword`      |
| `config.ldap.searchBase`                  |                                                                                         | `""`                |
| `config.ldap.useTrustStore`               |                                                                                         | `false`             |
| `config.ldap.userBaseDn`                  |                                                                                         | `""`                |
| `config.ldap.userSubtree`                 |                                                                                         | `false`             |
| `config.ldap.userObjectClass`             |                                                                                         | `""`                |
| `config.ldap.userFilter`                  |                                                                                         | `""`                |
| `config.ldap.userIdAttribute`             |                                                                                         | `""`                |
| `config.ldap.userRealNameAttribute`       |                                                                                         | `""`                |
| `config.ldap.emailAddressAttribute`       |                                                                                         | `""`                |
| `config.ldap.mapGroupsAsRoles`            |                                                                                         | `true`              |
| `config.ldap.adminGroup`                  |                                                                                         | `""`                |
| `config.ldap.mapGroupsAsRolesType`        | Roles can either be dynamic or static                                                   | `dynamic`           |
| `config.ldap.useMemberOfAttribute`        | If `config.ldap.mapGroupsAsRolesType` = `dynamic`                                       | `""`                |
| `config.ldap.groupBaseDn`                 | If `config.ldap.mapGroupsAsRolesType` = `static`                                        | `""`                |
| `config.ldap.groupSubtree`                | If `config.ldap.mapGroupsAsRolesType` = `static`                                        | `""`                |
| `config.ldap.groupObjectClass`            | If `config.ldap.mapGroupsAsRolesType` = `static`                                        | `""`                |
| `config.ldap.groupIdAttribute`            | If `config.ldap.mapGroupsAsRolesType` = `static`                                        | `""`                |
| `config.ldap.groupMemberFormat`           | If `config.ldap.mapGroupsAsRolesType` = `static`                                        | `""`                |
| `config.cleanup`                          | Define a cleanup job (see values.yaml for examples)                                     | `[]`                |
| `config.repos`                            | Define a Repository (see values.yaml for examples)                                      | `[]`                |
| `config.tasks`                            | Define a Task (see values.yaml for examples)                                            | `[]`                |
...
Since 3.21.2 Nexus [disables Groovy scripting](https://issues.sonatype.org/browse/NEXUS-23205) by default. Thus, custom properties has to be enabled with the value `nexus.scripts.allowCreation=true` for automatic configuration to work.
