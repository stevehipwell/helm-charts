...
| config.blobStores | list | `[]` | Blob store configuration, based on the REST API (the API reference can be found on an existing Nexus installation in the **Administration** section under _System_ → _API_). |
