...
{{- define "nexus3.kubeVersion" -}}
  {{- default .Capabilities.KubeVersion.Version (regexFind "v[0-9]+\\.[0-9]+\\.[0-9]+" .Capabilities.KubeVersion.Version) -}}
{{- end -}}

{{/* Get Ingress API Version */}}
{{- define "nexus3.ingress.apiVersion" -}}
  {{- if and (.Capabilities.APIVersions.Has "networking.k8s.io/v1") (semverCompare ">= 1.19.x" (include "nexus3.kubeVersion" .)) -}}
...
{{- define "nexus3.ingress.supportsPathType" -}}
  {{- or (eq (include "nexus3.ingress.isStable" .) "true") (and (eq (include "nexus3.ingress.apiVersion" .) "networking.k8s.io/v1beta1") (semverCompare ">= 1.18.x" (include "nexus3.kubeVersion" .))) -}}
{{- end -}}
