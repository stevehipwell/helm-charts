...
- Added `config.job.podLabels` to support custom pod labels for the configuration job ([#1265](https://github.com/stevehipwell/helm-charts/issues/1265)) _@jonathanchavez_
